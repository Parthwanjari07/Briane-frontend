        ...
        <header className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Here's your brand's current ad performance & competitor activity
            </p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className={`w-8 h-8 ${darkMode ? 'bg-dark-100' : 'bg-gray-300'} rounded-full overflow-hidden`}>
              <div className={`w-full h-full ${darkMode ? 'bg-purple-primary' : 'bg-blue-800'} flex items-center justify-center text-white font-medium`}>
